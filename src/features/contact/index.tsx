    ...
    <>
      <Box className={s.contactWrapper}>
       <Box className={s.contactWrapperLeft}>
         <Text className={s.contactWrapperTitle}>Нужна помощь в поиске уютного дома?</Text>
         <Text className={s.contactWrapperDescription}>Не стесняйтесь связаться с нами и начните свой путь к дому мечты. Мы поможем вам на каждом этапе!</Text>
       </Box>
        <Box className={s.contactWrapperRight}>
          ...
          />
          <Button className={'button-black'} fullWidth>Отправить</Button>
        </Box>
      </Box>
    </>
  )
